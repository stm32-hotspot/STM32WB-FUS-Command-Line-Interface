...
{
  if((LL_RCC_IsActiveFlag_SFTRST( ) || LL_RCC_IsActiveFlag_OBLRST( )) == 0)
  {
    /**
     * On Power up, the content of SRAM1 is random
     * wait for button
     * The default value could be changed to either
     *   CFG_SW1_FUS_FW_DELETE,
     *   CFG_SW2_FUS_FW_UPGRADE,
     *   CFG_SW3_FUS_CPU2_SWITCH,
     *   to send a command by default
     *   FOR SAFETY, SET CFG_BUTTON_SUPPORTED to 0
     */
